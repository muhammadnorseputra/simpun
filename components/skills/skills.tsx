...
export default function Skills() {
    return (
        <section id="skills"  className='overflow-x-hidden'>
          <div className="relative px-6 py-12 bg-gray-100 dark:bg-slate-900 overflow-hidden -mt-5" data-aos="fade-in" data-aos-delay="150" data-aos-anchor-placement="top">
            ...
            <div className="flex flex-wrap justify-evenly sm:justify-between items-center gap-y-3 gap-x-3 mt-8">
              <span className="w-28 h-28 rounded-2xl bg-white dark:bg-green-200 flex items-center justify-center relative overflow-hidden">
                <Skill type="boostrap" />
