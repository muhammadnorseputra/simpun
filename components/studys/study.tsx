        ...
        <div className="relative px-6 py-8 bg-slate-800 overflow-hidden">
          ...
          <div className="flex flex-nowrap space-x-10 mt-4 overflow-y-hidden overflow-x-auto scrolling-touch pb-8">
            ...
            <div key={study.id} className="min-w-[300px] h-28 bg-gray-100 rounded-2xl relative group">
              ...
              <div className="w-[260px] sm:w-[270px] h-2 bg-white/80 absolute left-5 -bottom-1 rounded-b-2xl transition-all delay-900 duration-800 ease-out group-hover:-translate-y-2 group-hover:opacity-0" />
              <div className="w-[230px] sm:w-[240px] h-2 bg-white/40 absolute left-10 -bottom-3 rounded-b-2xl transition-all group-hover:-translate-y-4  group-hover:opacity-0" />
            </div>
            ))}
          </div>
        </div>
