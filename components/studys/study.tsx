...
function Study({ studys }: any) {
	return (
	<section id="studys">
        <div className="relative px-6 py-8 bg-green-100 overflow-hidden">
          ...
          <h2 className="inline text-2xl font-bold text-slate-800 relative before:absolute before:w-1 before:h-full before:top-0 before:-left-6 before:rounded-r-3xl before:bg-slate-800 before:animate-pulse">Study</h2>
