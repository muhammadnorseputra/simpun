...
function Contacts() {
  ...
  return (
    ...
    <div className="relative px-6 py-8 overflow-hidden bg-green-50 dark:bg-slate-800 z-10">
      <h2 className="inline text-2xl font-bold text-slate-800 dark:text-slate-100 relative before:absolute before:w-1 before:h-full before:top-0 before:-left-6 before:rounded-r-3xl before:bg-slate-400 before:animate-pulse">
        #Contact Me
      </h2>
      <div className="text-sm text-gray-600 mt-4 pb-4">
          <div className="flex items-center justify-start gap-5">
            <HomeIcon className='w-6 h-6 text-black dark:text-slate-400' />
            <div>
              <p className="font-bold text-black dark:text-slate-400">Address</p>
              Desa. Banua Hanyar, RT. 02 No. 74 Kec. Batumandi Kab. Balangan.
            </div>
          </div>
          <div className="flex items-center justify-start gap-5">
            <InboxIcon className='w-6 h-6 text-black dark:text-slate-400' />
            <div>
              <p className="font-bold text-black dark:text-slate-400 mt-2">Email</p>
          ...
          <div className="flex items-center justify-start gap-5">
            <PhoneIcon className='w-6 h-6 text-black dark:text-slate-400' />
            <div>
              <p className="font-bold text-black dark:text-slate-400 mt-2">WhatsApp</p>
              +62 82151815132
      ...
      <form onSubmit={formik.handleSubmit} noValidate className="p-4 border border-green-600 rounded-b-xl">
        ...
        <div className="relative z-0 mb-6 w-full group">
            ...
            name="message" 
            rows={4} 
            className={`resize-none block p-2.5 w-full text-md text-black bg-white dark:bg-gray-900 border dark:border-0 ${!formik.errors.message && formik.touched.message ? `border-green-700 dark:border-green-300` : 'border-white'} focus:ring-green-500 focus:border-green-500 dark:placeholder-gray-400 dark:text-black dark:focus:ring-green-500 dark:focus:border-green-500`} placeholder="Type Your message here..." value={formik.values.message} />
