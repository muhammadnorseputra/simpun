  ...
  return (
    <section id="projects" className='overflow-x-hidden'>
      <div className="relative px-6 py-12 min-h-[300px] bg-white dark:bg-green-500 shadow-t-2xl -mt-5 rounded-t-2xl rounded-b-2xl dark:rounded-b-none overflow-hidden z-10" data-aos="fade-in" data-aos-delay="150">
        ...
        <h2 className="inline text-2xl font-bold text-slate-800 dark:text-green-100 relative before:absolute before:w-1 before:h-full before:top-0 before:-left-6 before:rounded-r-3xl before:bg-white before:animate-pulse">
          Project
        </h2>
