...
function HeroGlow() {
	return (
		<section>
        <div className="px-4 py-12 relative bg-white/60 backdrop-blur-sm overflow-hidden z-0">
          <div className="w-72 h-72 animate-debouce rounded-full absolute filter blur-2xl opacity-30 bg-amber-300 top-12 left-1/2 mix-blend-multiply"></div>
          <div className="w-72 h-72 animate-debouce animate-delay-2000 rounded-full absolute filter blur-2xl opacity-30 bg-teal-300 bottom-12 left-1/4 mix-blend-multiply"></div>
          <div className="w-72 h-72 animate-debouce animate-delay-4000 rounded-full absolute filter blur-2xl opacity-30 bg-violet-300 top-4 right-1/2 mix-blend-multiply"></div>
