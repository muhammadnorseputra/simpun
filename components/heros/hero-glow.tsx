...
function HeroGlow( { my }: any ) {
  const { intro, tagline, description } = my
	return (
		<section>
        <div className="px-8 sm:px-4 py-12 relative bg-white/60 dark:bg-black/70 animate-reduce overflow-hidden z-0">
          ...
          <div className="relative flex flex-col items-start justify-between space-y-8">
            ...
            <div className="mx-0 sm:mx-5 md:mx-10">
              ...
              <p className="text-3xl tracking-normal font-bold py-2 text-green-700 dark:text-green-400"  data-aos="fade-up" data-aos-delay="300">{tagline}</p>
              <p className="tracking-wider md:text-md leading-6 text-black/90 dark:text-gray-100" data-aos="fade-in" data-aos-delay="400"> {description} </p>
